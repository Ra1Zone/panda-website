...
import { contactStore, settingsStore } from "@/store/dataStore";
...
const Contact = () => {
  ...
  // Read contact info from settings store with defaults
  ...
  const submit = (e: FormEvent) => {
    ...
    setStatus("loading");
    contactStore.add({ name: form.name, phone: form.phone, email: form.email, message: form.message });
